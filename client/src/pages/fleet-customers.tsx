...
export default function FleetCustomersPage() {
  ...
  const deleteMutation = useMutation({
    ...
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ["umugwaneza", "customers", businessId, "FLEET"] });
      toast({ title: t("fleet_customers.customer_updated"), description: "Customer deleted." });
                  ...
                  <TableBody>
                    {list.pageItems.map((c, i) => (
                      ...
                      >
                        ...
                        <TableCell className="text-[#64748b] max-w-[220px] truncate">{c.notes || "—"}</TableCell>
                        <TableCell className="text-right">
                          <div className="flex items-center justify-end gap-2">
                            ...
                            <Button
                              ...
                              data-testid={`button-delete-fleet-customer-${c.id}`}
                            >
