...
import { Package, TrendingUp, TrendingDown, Banknote, AlertTriangle } from "lucide-react";
...
export function GroceryKpiRow({ grocery }: { grocery: GroceryStats }) {
