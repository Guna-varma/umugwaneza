-- UMUGWANEZA LTD - Tables in PUBLIC schema (same DB as HAPYJO; fleet_vehicles avoids clash with public.vehicles)
...
-- Fleet Vehicles (avoids clash with HAPYJO public.vehicles; hapyjo_vehicle_id links to public.vehicles.id)
